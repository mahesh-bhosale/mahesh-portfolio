export const navItems = [
  ...
  export const gridItems = [
    ...
    {
      id: 2,
      title: "Collaborative and adaptive to team environments.",
      description: "",
    ...
    },
    {
      id: 3,
      title: "My tech stack",
      description: "React, Node.js, PostgreSQL, MongoDB, AWS, and more.",
      className: "lg:col-span-2 md:col-span-3 md:row-span-2",
      imgClassName: "",
  ...
  export const projects = [
    {
      ...
      img: "/attendance.svg",
      iconLists: ["/postgresql.svg", "/react.svg", "/next.svg", "/js.svg"],
